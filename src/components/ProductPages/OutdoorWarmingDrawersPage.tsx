...
const product = {
  ...
  href: "/products/outdoor-warming-drawer-wwdo/wwdo",
} as const;
...
export function OutdoorWarmingDrawersPage() {
  return (
    <main className="bg-[#f4f2ec] text-[#181817]" style={{ fontFamily: '"Segoe UI", Arial, Helvetica, sans-serif' }}>
      <section className="relative h-[520px] overflow-hidden bg-[#0c0c0b] text-white md:h-[100svh] md:max-h-[1080px]">
        <Image src={assets.hero} alt="Premium outdoor kitchen with Wolf appliances" fill preload sizes="100vw" className="object-cover object-center" />
      ...
      <section className="px-6 pb-16 md:px-12 md:pb-20">
        <div className="mx-auto max-w-[1392px]">
          ...
          <div className="pb-12 pt-4 text-[11px] md:pb-[70px]">
            <p className="font-semibold uppercase tracking-[0.18em]">Selected filters (1)</p>
            <div className="mt-3 flex items-center gap-4">
              <span className="rounded-full border border-[#181817] px-3 py-1.5">Warming Drawer ×</span>
              <Link href="/cooking/outdoor" className="underline underline-offset-4">Clear all</Link>
            </div>
          </div>

          <section aria-label="Warming Drawer products">
            <div className="grid gap-1 sm:grid-cols-2 lg:grid-cols-3">
              <article className="w-full max-w-[459px] border border-[#d2cdc1] p-5 md:p-6 md:pb-[14px]">
                <Link href={product.href} className="group block focus:outline-none focus-visible:ring-1 focus-visible:ring-[#181817]">
                  <div className="relative aspect-[4/5] overflow-hidden md:h-[598px] md:aspect-auto">
                    <Image src={assets.warmingDrawer} alt="Wolf Outdoor Warming Drawer" fill preload sizes="(min-width: 1024px) 408px, (min-width: 640px) 46vw, 88vw" className="object-contain transition duration-500 group-hover:scale-[1.02]" />
                  </div>
                  <h2 style={serif} className="pb-4 text-[20px] font-light leading-[1.2] underline-offset-4 group-hover:underline md:text-[24px]">{product.title}</h2>
                </Link>
                <dl className="mt-3 border-t border-[#d8d2c8] text-[12px] font-light leading-[1.35]">
                  <div className="grid grid-cols-2 py-2"><dt>Width:</dt><dd>30&quot;</dd></div>
                </dl>
              </article>
            </div>
