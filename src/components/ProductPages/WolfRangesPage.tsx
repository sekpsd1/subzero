  ...
  return (
    <main className="bg-[#f4f2ec] text-[#171715]">
      ...
      <section className="px-6 pb-24 pt-14 text-center md:px-12 md:pb-32 md:pt-16">
        ...
        <h1 className="mt-3 font-serif text-[clamp(3.5rem,5.55vw,5rem)] leading-none tracking-[-0.035em]">Ranges</h1>
        ...
        <div className="mt-7">
          <Link href="/showroom" className="inline-flex min-h-[52px] items-center justify-center rounded-full bg-[#171715] px-8 text-base font-bold text-white transition hover:bg-[#393834]">Experience in a showroom</Link>
        </div>
      ...
      <section id="range-families" className="px-6 pb-24 md:px-12 md:pb-32">
        <div className="mx-auto max-w-[1556px] space-y-24 md:space-y-32">
          {families.map((family, index) => <article key={family.title} className={`grid items-center gap-10 md:grid-cols-2 md:gap-20 2xl:items-start ${index % 2 ? "2xl:grid-cols-[718px_718px] 2xl:gap-[129px]" : "2xl:grid-cols-[718px_486px] 2xl:gap-[177px]"}`}>
            ...
            <div className={`mx-auto flex w-full max-w-[486px] flex-col items-center text-center ${index % 2 ? "md:order-1 2xl:translate-x-[77px]" : ""}`}><h2 className="font-serif text-[clamp(2.65rem,3.75vw,3.75rem)] leading-none">{family.title}</h2><p className="mt-7 font-serif text-[clamp(1.25rem,1.25vw,1.375rem)] leading-[1.25]">{family.description}</p>{family.showOptions && <FamilyOptions names={family.options} detailed={family.title === "Dual Fuel" || family.title === "Gas"} />}{family.optionDescription && <p className="mt-10 w-full text-left text-base leading-[1.25] text-black/75">{family.optionDescription}</p>}<div className="mt-10"><Link href={family.href} className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-[#171715] px-8 text-base font-bold text-white transition hover:bg-[#393834]">{family.learn}<span className="grid size-6 place-items-center rounded-full border border-white text-xl font-light leading-none" aria-hidden="true">+</span></Link></div><Link href={family.href} className="mt-5 inline-flex border-b border-[#171715] pb-1 text-base">{family.view}</Link></div>
          </article>)}
        </div>
      </section>

      <section className="bg-[#fbfaf7] px-6 py-20 md:px-12">
        <div className="mx-auto max-w-[1296px]"><h2 className="text-center font-serif text-[clamp(2.8rem,4.2vw,3.75rem)] font-normal leading-none">Wolf Ranges overview</h2>
      ...
      <section className="px-6 py-20 md:px-12"><div className="mx-auto max-w-[1392px] space-y-20">
        ...
        <section aria-labelledby="complete-your-kitchen"><h2 id="complete-your-kitchen" className="font-serif text-[clamp(2.8rem,4.2vw,3.75rem)] font-normal leading-none">Complete your kitchen</h2><div className="mt-8 flex snap-x snap-mandatory gap-2 overflow-x-auto md:grid md:grid-cols-2 md:overflow-visible">{[
