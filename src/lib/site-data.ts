...
export const mainNavigation: NavItem[] = [
  {
    ...
    children: [
      ...
      { title: "French Door", href: "/refrigeration/french-door" },
      { title: "Side-by-Side", href: "/refrigeration/side-by-side" },
      { title: "Over-and-Under", href: "/refrigeration/over-and-under" },
    ...
    children: [
      { title: "Discover Wolf", href: "/cooking/discover-wolf", featured: true },
      {
        ...
        children: [
          ...
          { title: "Induction", href: "/cooking/ranges-induction" },
          { title: "Gas", href: "/cooking/ranges/gas" },
        ],
      },
      {
      ...
      },
      {
        ...
        href: "/cooking/cooktops-rangetops",
        featured: true,
        children: [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Warming Drawers", href: "/outdoor/warming-drawers" },
      { title: "Accessories", href: "/cooking/accessories" },
    ],
  },
  {
...
export const products: Product[] = [
  ...
  },
  {
    ...
    brand: "Sub-Zero",
    category: "Refrigeration",
    series: "Outdoor Refrigeration",
    type: "Outdoor Refrigeration",
    width: "61 cm",
    finish: "Stainless",
    status: "active",
    stock: 4,
